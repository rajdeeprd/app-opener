...
import {
  ...
  Play, Heart, Map, Share2, Phone, Info
} from "lucide-react";
...
const PLATFORMS = [
  ...
  { id: "instagram", name: "Instagram", icon: Heart, color: "text-pink-500" },
  { id: "whatsapp", name: "WhatsApp", icon: Phone, color: "text-green-500" },
  { id: "google_maps", name: "Google Maps", icon: Map, color: "text-blue-500" },
  { id: "twitter", name: "Twitter / X", icon: Share2, color: "text-sky-500" },
] as const;
